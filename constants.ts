...
- <i class="fas fa-cog"></i> Configuration:
  ...
  - Options d’impression: Afficher/masquer les descriptions à l’impression.
...
☐ أنشئ قسم/فصل جديد من لوحة التحكم ➜ أدخل الاسم والمادة ثم أكد.
☐ افتح القسم واضبط المعلومات (اسم الأستاذ، المؤسسة) من الإعدادات.
...
🖨️ قبل الطباعة، راجع خيارات الطباعة في الإعدادات.
...
- اسم القسم/الفصل: قابل للتحرير بالنقر عليه (إدخال للحفظ، هروب للإلغاء).
...
- <i class="fas fa-ellipsis-v"></i> المزيد:
  ...
  - <i class="fas fa-file-export"></i> تصدير JSON: تنزيل ملف .json للقسم الحالي.
  ...
  - <i class="fas fa-question-circle"></i> مساعدة: يفتح هذا الدليل.

## لوحة التحكم
- بطاقة القسم: اسم القسم وتاريخ آخر تعديل؛ انقر للفتح.
- <i class="fas fa-times"></i> حذف (يظهر عند المرور): حذف القسم بعد التأكيد.
- إنشاء قسم جديد: بطاقة كبيرة بعلامة +؛ أدخل الاسم والمادة. اسم الأستاذ الافتراضي من الإعدادات.
- <i class="fas fa-cog"></i> الإعدادات:
  - معلومات عامة: اسم المؤسسة، اسم الأستاذ الافتراضي.
  - خيارات الطباعة: إظهار الوصف عند الطباعة أو إخفاؤه.
  - إدارة البيانات: تصدير الكل / استيراد نسخة احتياطية (جميع الأقسام + الإعدادات).
...
### الطباعة
- عبر خيار الطباعة؛ العناوين الرئيسية في الوسط؛ دعم صيغ الرياضيات؛ يمكن إظهار/إخفاء الوصف من الإعدادات.
...
- تصدير/استيراد JSON للقسم الحالي من قائمة المزيد.
- تصدير/استيراد المنصة (كل الأقسام + الإعدادات) من "الإعدادات".
